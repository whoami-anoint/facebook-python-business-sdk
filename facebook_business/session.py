...
class FacebookSession:
    ...
    FB_CA_CHAIN_BUNDLE = os.path.join(os.path.dirname(__file__), 'fb_ca_chain_bundle.crt')

    def __init__(self, app_id=None, app_secret=None, access_token=None, proxies=None, timeout=None, debug=False):
        """
        ...
        self.requests.verify = self.FB_CA_CHAIN_BUNDLE
        params = {
